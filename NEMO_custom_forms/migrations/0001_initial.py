# Generated by Django 4.2.15 on 2024-12-28 00:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "role",
                    NEMO_custom_forms.models.RoleGroupPermissionChoiceField(
                        help_text="The role/group required for users to take the action",
                        max_length=255,
                        verbose_name="Role/Group",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "action_result",
                    models.BooleanField(default=False, help_text="Whether the action was approved/acknowledged"),
                ),
                (
                    "action",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="NEMO_custom_forms.customformaction"
                    ),
                ),
                (
                    "action_taken_by",
